...
async function createFrontend(options) {
  ...
  try {
    ...
    // Step 2: Copy frontend template
    spinner.text = 'Copying frontend storefront template files...';
    spinner.start();
    
    const sourceDir = path.join(__dirname, '..', 'templates', 'frontend');
    ...
    // Success message
    console.log('\n');
    console.log(chalk.green('✅ Frontend storefront created successfully!\n'));
    ...
    console.log('\n');
    console.log(chalk.gray('Frontend will run on: http://localhost:3000'));
    console.log('\n');
