...
export default function EditBannerPage() {
  ...
  useEffect(() => {
    if (bannerData) {
      setFormData({
        ...
        sortOrder: bannerData.sortOrder?.toString() || '0',
      ...
      setMobileImage(bannerData.mobileImage || '');
    }
  }, [bannerData]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.put(`/banners/${bannerId}`, bannerData);
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        {/* Main Content - Same structure as new page */}
